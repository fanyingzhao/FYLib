...
+ (UIImage *)createQRWithString:(NSString *)qrString {
    return [QrCodeHelper createQRWithString:qrString size:250.f];
}
...
+ (UIImage *)createQRWithString:(NSString *)qrString size:(CGFloat)size {
    ...
    return [QrCodeHelper createNonInterpolatedUIImageFormCIImage:qrFilter.outputImage withSize:size];
}
